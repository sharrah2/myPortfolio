  ...
  <body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
        ...
        <div id="content" class="container-fluid">
            ...
            <section id="experience">
                ...
                <div class="timeline container">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="date">
                                <h2>April 2018 - November 2018</h2>
                            </div>
                            <div class="carot-top"></div>
                            <div class="carot"></div>
                        </div>
            ...
            <section id="work">
                <h1 style="text-align:center">Selected Works</h1>
                <div class="container-fluid">
                    ...
                    <div class="portfolio">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="/views/detail_page.php?type=email" target="blank">
                                        <img src="/img/cover/email_cover.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="/views/logo.php?work=logo" target="blank">
                                        <img src="/img/cover/logo_cover.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="/views/ig.php?work=email" target="blank">
                                        <img src="/img/cover/socialMedia_cover.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="/views/tv.php">
